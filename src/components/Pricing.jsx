      ...
      <div className="container grid grid--2-cols margin-bottom-md">
        <div className="pricing-plan pricing-plan--starter">
          ...
          <ul className="list">
            ...
            <li className="list-item cross"><span>Get access to latest recipes</span></li>
          </ul>
        ...
        <div className="pricing-plan pricing-plan--complete">
          ...
          <ul className="list">
            <li className="list-item"><span><strong>2 meals</strong> per day</span></li>
            <li className="list-item"><span>Order <strong>24/7</strong></span></li>
            <li className="list-item"><span>Delivery is free</span></li>
